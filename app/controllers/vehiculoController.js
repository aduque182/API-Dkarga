...
router.post('/vehiculo', (req, res, next) =>{
  ...
  router.get('/vehiculos', (req, res, next)=> {
    ...
    router.get('/vehiculos/:vehiculoId', (req, res, next)=> {
      ...
      router.put('/vehiculos/:vehiculoId', (req, res, next) =>{
        let vehiculoId = req.params.vehiculoId
    ...
    router.delete('/vehiculos/:vehiculoId', (req, res, next) => { 
      let vehiculoId = req.params.vehiculoId
